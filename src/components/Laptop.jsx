...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex md:min-h-[150vh] min-h-[60vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-20 py-6">
      <motion.h2
        style={{
        ...
        {title || (
          <span className="">
            Looking for art to buy? <br /> Look No more.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
    ...
    <div className="relative [perspective:800px]">
      <div
        ...
        <div
          ...
          <span className="text-red-500">
            <img src="../images/broddie.jpeg" className="object-fit overflow-hidden rounded-xl h-40 w-40" alt="" />
            {/* <AceternityLogo /> */}
          </span>
        </div>
      </div>
      <motion.div
        ...
        <video
          ...
          autoPlay
          loop
          className="absolute inset-0 h-full w-full rounded-lg object-cover object-left-top" ></video>
      </motion.div>
    </div>
  );
};
